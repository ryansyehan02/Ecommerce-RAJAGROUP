	...
	<div class="container-fluid justify-content-center">
		<div class="row py-2 px-5 align-items-center bg-body">
				...
				<nav class="navbar navbar-expand-lg bg-body">
						...
						<div class="collapse navbar-collapse justify-content-center" id="navbarNav">
							<ul class="navbar-nav">
								...
								<li class="nav-item px-2">
									<a class="nav-link fs-5" href="transaksi_order/transaksi_pages.php">
			...
			<div class="col-2">
				...
				<a href="../logout_proses.php" class="text-link text-decoration-none align-middle fs-5">Sign Out</a>
			</div>
		</div>
	</div>
</body>
