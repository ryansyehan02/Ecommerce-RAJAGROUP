<div class="container-fluid py-2" style="background-image:linear-gradient(#ffffff, #b5c4ff);">  
		<div class="row justify-content-center border-bottom">
			...
			<div class="col-2 py-3">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item py-1">
						<a href="" class="link-dark text-decoration-none">Balenciaga</a>
					</li>
					<li class="nav-item py-1">
						<a href="" class="link-dark text-decoration-none">Nike</a>
					</li>
					<li class="nav-item py-1">
			...
			<div class="col-2 py-3">
				<h6 class="h6 fw-bold">Social Media</h6>
				<ul class="nav flex-column">
					...
					<li class="nav-item py-1 justify-content-center">
						<a href="www.instagram.com/" class="link-dark text-decoration-none">
		...
		<div class="row px-2 py-3 text-muted align-items-center">
				...
				<div class="col-7 text-center">
					<i class="fas fa-envelope"></i>
						rajagroupindonesia@gmail.com
					&nbsp;
					<i class="fas fa-phone"></i>
						+62-853-6916-7831
					<br>
					<i class="fas fa-home"></i>
						Jl. Cempaka No.61A, Kec. Medan Helvetia, Kota Medan, Sumatera Utara 20125
				</div>
				<div class="col-2 text-center">
					...
					|
					<img src="img/icons/bri.png" alt="" width="50px">
				</div>
			</div>
		</div>
	</div>