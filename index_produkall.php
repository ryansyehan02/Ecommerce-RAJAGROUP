	...
	<div class="container">
		<div class="row justify-content-evenly">
			<?php 
				...
				// ini adalah query untuk menampilkan seluruh data produk pada tabel tb_produk dengan kondisi dimana stok_produk lebih dari atau sama dengan 1pcs (>=)
				$resultProduk = mysqli_query($connection, "SELECT * FROM tb_produk WHERE stok_produk >= 1 ORDER BY RAND()");
			...
			<div class="card rounded mx-3 my-5" style="width:20rem;">
				<img src="img/produk/<?php echo $fetchProduk['gambar_produk'];?>" class="card-img-top" height="300px" alt="...">
				<div class="card-body px-1 text-end">
					...
					<p class="card-text text-start text-muted">
						...
						<br>
						<span>Stok : <?php echo $stok_produk; ?></span>				
					</p>
				</div>
				<div class="card-footer bg-transparent align-items-center fs-6 fst-italic text-muted">
					<div class="row align-items-center">
						...
						<div class="col-6 d-grid px-0">
							<a href="index_produkdetail.php?id_produk=<?php echo $data_id_produk; ?>" class="btn btn-sm p-2 btn-outline-danger fw-bold">
