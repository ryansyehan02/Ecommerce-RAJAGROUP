            ...
            <div class="col-8">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="index_produkall.php">Products</a></li>
                        <li class="breadcrumb-item"><a href="index_produkall.php">All Products</a></li>
    ...
    <div class="container py-3">
        ...
        <div class="row rounded-3 shadow-lg my-5">
            ...
            <div class="col-2 d-grid align-self-center">
                <a href="" class="btn btn-primary text-white rounded-3 py-5" data-bs-toggle="modal" data-bs-target="#modalLogin">
        ...
        <div class="row justify-content-evenly">
            ...
            <div class="card rounded-3 shadow" style="width: 16rem; height:28rem;">
                ...
                <div class="card-footer bg-transparent text-end">
                    <a href="index_produkdetail.php?id_produk=<?php echo $upsell_id_produk; ?>" class="btn btn-primary">
            ...
            <div class="card rounded-3 shadow" style="width: 16rem; height:28rem;">
                ...
                <div class="card-footer bg-transparent text-end">
                    <a href="index_produkdetail.php?id_produk=<?php echo $upsell2_id_produk; ?>" class="btn btn-primary">
                        <i class="fas fa-eye"></i>
                        Lihat Produk
                    </a>
                </div>
